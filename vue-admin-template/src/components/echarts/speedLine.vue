      ...
      option: {
        ...
        tooltip: {
          ...
          formatter: function (params, ticket, callback) {
              ...
              var value1 = Math.round(value[1], 0)
              var i=0;
              while (value1>1024){
                value1 /= 1024;
                i++;
              }
              value1 = Math.round(value1, 0)+prefix_arr[i];

              var valueFliter=(value,index)=>{return `${value[0].replace("T"," ")}  ${value1}`}
        ...
        yAxis: {
          ...
          axisLabel:{
            formatter:(value,index)=>{
              ...
              value = Math.round(value, 0)+prefix_arr[i];
              return value
            }
          }
        },
